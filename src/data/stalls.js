...
export const STALLS = [
  ...
  { id: 's22', name: '駄菓子屋 とうこう堂', org: '1年D組', cat: 'food', loc: { type: 'room', building: 'minami', floor: '1f', room: 'm1-2' }, placeLabel: '南校舎1F 1年D組', menu: [['駄菓子詰め合わせ', 200]], hours: '10:00〜15:30', pr: '昭和レトロな教室で懐かしの駄菓子はいかが?' },
  ...
  // --- 北校舎 ---
  { id: 's27', name: 'わたあめ工場', org: '中学3年A組', cat: 'food', loc: { type: 'room', building: 'chugaku', floor: '1f', room: 'c1-1' }, placeLabel: '北校舎1F 中1A組', menu: [['わたあめ', 200], ['カラフル', 300]], hours: '10:00〜15:00', pr: '虹色わたあめ、写真映え間違いなし!' },
  { id: 's28', name: 'ポップコーン屋台', org: '中学3年B組', cat: 'food', loc: { type: 'room', building: 'chugaku', floor: '1f', room: 'c1-2' }, placeLabel: '北校舎1F 中1B組', menu: [['塩/キャラメル', 250]], hours: '10:00〜15:00', pr: 'できたてポンポン弾ける音もお楽しみ。' },
